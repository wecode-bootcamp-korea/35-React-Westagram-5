          ...
          <nav className="navTop">
            <div className="topContainer">
              ...
              <div className="iconContainer">
                ...
                <img className="mainUser" src="images/mainUser.PNG" />
              </div>
            </div>
          </nav>
            ...
            <div className="stories">
              <div className="storyWrapper">
                <div className="strbox">
                  <img className="strProfile1" src="../images/cat1.jpg" />
              ...
              <div className="userRecommend">
                ...
                <div className="recommendList">
                  <div className="recommendInfo">
                    <img className="recommendUser" src="../images/mouse.jpg" />
                  ...
                  <div className="recommendInfo">
                    <img className="recommendUser" src="../images/meme.jpg" />
                    <div className="acntDetail">
            ...
            <div className="feed">
              <div className="feedHeader">
                <div className="feedContainer">
                  <img className="feedHeaderImg" src="../images/jerry.jpg" />
              ...
              <img className="feedImg" src="../images/codelin.jpg" />
              ...
              <div className="cmtContainer">
                ...
                <form className="comment" onSubmit="return false">
                  ...
                  />
                  <button type="submit" className="commbtn" onClick={this.add}>
                    게시
                  </button>
                </form>
              </div>
